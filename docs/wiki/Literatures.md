...
## SAR11 Paper Networks

The interactive VOSviewer panels summarize several relationships within the literature collection:

- Citation relationships among papers
- Citation relationships among authors
- Co-occurrence of keywords in titles and abstracts
- Co-authorship relationships

Use the VOSviewer controls to zoom, search, change the visualization, and inspect individual nodes. Network proximity and link strength describe patterns in the indexed literature and should not be treated as a direct measure of scientific quality.
