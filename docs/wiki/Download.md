...
- **Phylogenetic trees**: the updated bac120 IQ-TREE phylogeny was rooted with 20 outgroups and pruned to 542 SAR11 genomes. Orthogroup-level trees are prepared separately.
...
The displayed bac120 IQ-TREE file can be downloaded directly from the phylogenetic-tree card. It contains the same 542 SAR11 tips used by the Genome Information Taxonium view.
