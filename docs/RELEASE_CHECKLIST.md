...
- [ ] Calculate all-vs-all average nucleotide identity for the 542 SAR11 genomes, validate the genome ordering and matrix symmetry, and record the tool, version, command, and thresholds used. Prepare the ANI matrix for download and replace its Coming soon card with a release link.
